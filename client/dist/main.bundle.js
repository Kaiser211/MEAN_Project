...
var frame_component_1 = __webpack_require__("./src/app/frame/frame.component.ts");
var dashboard_component_1 = __webpack_require__("./src/app/frame/dashboard/dashboard.component.ts");
var login_registration_component_1 = __webpack_require__("./src/app/login-registration/login-registration.component.ts");
var registration_component_1 = __webpack_require__("./src/app/login-registration/registration/registration.component.ts");
var new_question_component_1 = __webpack_require__("./src/app/frame/new-question/new-question.component.ts");
var show_question_component_1 = __webpack_require__("./src/app/frame/show-question/show-question.component.ts");
var new_answer_component_1 = __webpack_require__("./src/app/frame/new-answer/new-answer.component.ts");
var routes = [
    {
        // localhost:8000/dashboard/
        path: 'dashboard', component: frame_component_1.FrameComponent, children: [
            { path: '', component: dashboard_component_1.DashboardComponent },
            { path: 'new/Question', component: new_question_component_1.NewQuestionComponent },
            { path: 'question/:id', component: show_question_component_1.ShowQuestionComponent },
            { path: 'new/Answer/:id', component: new_answer_component_1.NewAnswerComponent },
        ]
    },
    {
        // localhost:8000/
        path: '', component: login_registration_component_1.LoginRegistrationComponent, children: [
...
var dashboard_component_1 = __webpack_require__("./src/app/frame/dashboard/dashboard.component.ts");
var show_question_component_1 = __webpack_require__("./src/app/frame/show-question/show-question.component.ts");
var login_component_1 = __webpack_require__("./src/app/login-registration/login/login.component.ts");
var registration_component_1 = __webpack_require__("./src/app/login-registration/registration/registration.component.ts");
...
var answer_service_1 = __webpack_require__("./src/app/services/answer.service.ts");
    ...
    AppModule = __decorate([
        core_1.NgModule({
            declarations: [
                ...
                new_answer_component_1.NewAnswerComponent,
...
/***/ "./src/app/frame/dashboard/dashboard.component.css":
/***/ (function(module, exports) {
...
/***/ "./src/app/frame/dashboard/dashboard.component.html":
/***/ (function(module, exports) {
...
/***/ "./src/app/frame/dashboard/dashboard.component.ts":
/***/ (function(module, exports, __webpack_require__) {
...
var DashboardComponent = /** @class */ (function () {
    ...
    DashboardComponent = __decorate([
        core_1.Component({
            ...
            template: __webpack_require__("./src/app/frame/dashboard/dashboard.component.html"),
            styles: [__webpack_require__("./src/app/frame/dashboard/dashboard.component.css")]
        }),
...
var FrameComponent = /** @class */ (function () {
    function FrameComponent(_http, _router, _userService) {
        this._http = _http;
        this._router = _router;
        this._userService = _userService;
    ...
    FrameComponent.prototype.getUserSession = function () {
        var _this = this;
    ...
    FrameComponent.prototype.logout = function () {
        var _this = this;
...
/***/ "./src/app/frame/new-answer/new-answer.component.css":
/***/ (function(module, exports) {
...
var NewAnswerComponent = /** @class */ (function () {
    function NewAnswerComponent(_router, _route, _answerService, _questionService) {
        this._router = _router;
        this._route = _route;
        this._answerService = _answerService;
        this._questionService = _questionService;
    ...
    NewAnswerComponent = __decorate([
        core_1.Component({
            ...
            template: __webpack_require__("./src/app/frame/new-answer/new-answer.component.html"),
            styles: [__webpack_require__("./src/app/frame/new-answer/new-answer.component.css")]
        }),
...
/***/ "./src/app/frame/new-question/new-question.component.css":
/***/ (function(module, exports) {
...
/***/ "./src/app/frame/new-question/new-question.component.html":
/***/ (function(module, exports) {

module.exports = "<a [routerLink]=\"['/dashboard']\">Home</a> \n\n<fieldset>\n  <legend>New Question</legend>\n  <form (submit)=\"createQuestion()\">\n\n    <label>Question:</label><br>\n    <div *ngIf=\"question.invalid && (question.dirty || question.touched)\">\n      <p *ngIf=\"question.errors.required\" style=\"color: red;\">Question is required</p>\n      <p *ngIf=\"question.errors.minlength && !question.errors.required\" style=\"color: red;\">Question must be at least 10 characters</p>\n    </div>\n    <textarea name=\"question\" required minlength=\"10\" cols=\"40\" rows=\"4\" [(ngModel)]=\"newQuestion.question\" #question=\"ngModel\"></textarea><br>\n    \n    <label>Description:<small>(optional)</small></label><br>\n    <textarea name=\"description\" cols=\"40\" rows=\"4\" [(ngModel)]=\"newQuestion.description\"></textarea><br>\n    <br>\n    <button href [routerLink]=\"['/dashboard']\">Cancel</button>\n\n    <input type=\"submit\" value=\"Submit\">\n    \n  </form>\n</fieldset>"

/***/ }),

/***/ "./src/app/frame/new-question/new-question.component.ts":
/***/ (function(module, exports, __webpack_require__) {
...
var NewQuestionComponent = /** @class */ (function () {
    function NewQuestionComponent(_router, _quetionService) {
        this._router = _router;
    ...
    NewQuestionComponent = __decorate([
        core_1.Component({
            ...
            template: __webpack_require__("./src/app/frame/new-question/new-question.component.html"),
            styles: [__webpack_require__("./src/app/frame/new-question/new-question.component.css")]
        }),
        __metadata("design:paramtypes", [router_1.Router,
            question_service_1.QuestionService])
...
/***/ "./src/app/frame/show-question/show-question.component.css":
/***/ (function(module, exports) {
...
/***/ "./src/app/frame/show-question/show-question.component.html":
/***/ (function(module, exports) {

module.exports = "<a [routerLink]=\"['/dashboard']\">Home</a> |\n<a [routerLink]=\"['/dashboard/new/Answer', question._id]\">Answer this Question</a>\n\n\n<h2>{{question.question}}</h2>\n<p>{{question.description}}</p>\n<hr>\n\n  <div class=\"card\" *ngFor=\"let answer of answers\">\n    <div class=\"answer\">\n        <small class=\"name\">{{ answer._user.first_name }}:</small><br>\n        <h4>{{answer.answer}}</h4>\n        <p><small>{{ answer.detail }}</small> </p>\n    </div>\n    <div class=\"like\">\n      <p>{{ answer.likes }} likes <button (click)='likeAnswer(answer._id)' style=\"color: blue\" >Like!</button></p>\n      \n    </div>\n    \n  </div>\n"

/***/ }),

/***/ "./src/app/frame/show-question/show-question.component.ts":
/***/ (function(module, exports, __webpack_require__) {
...
var ShowQuestionComponent = /** @class */ (function () {
    ...
    ShowQuestionComponent = __decorate([
        core_1.Component({
            ...
            template: __webpack_require__("./src/app/frame/show-question/show-question.component.html"),
            styles: [__webpack_require__("./src/app/frame/show-question/show-question.component.css")]
        }),
        __metadata("design:paramtypes", [router_1.Router,
            router_2.ActivatedRoute,
            question_service_1.QuestionService,
...
/***/ "./src/app/login-registration/login/login.component.html":
/***/ (function(module, exports) {
...
var LoginComponent = /** @class */ (function () {
    ...
    LoginComponent = __decorate([
        core_1.Component({
            selector: 'app-login',
            template: __webpack_require__("./src/app/login-registration/login/login.component.html"),
            styles: [__webpack_require__("./src/app/login-registration/login/login.component.css")]
        }),
        __metadata("design:paramtypes", [router_1.Router,
            user_service_1.UserService])
    ], LoginComponent);
...
var RegistrationComponent = /** @class */ (function () {
    ...
    RegistrationComponent = __decorate([
        core_1.Component({
            ...
            template: __webpack_require__("./src/app/login-registration/registration/registration.component.html"),
            styles: [__webpack_require__("./src/app/login-registration/registration/registration.component.css")]
        }),
        __metadata("design:paramtypes", [router_1.Router,
            user_service_1.UserService])
